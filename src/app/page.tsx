            ...
            <div className={`space-y-6 transition-all duration-1000 transform ${
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-2">
                <Button 
                  ...
                  className="px-8 py-3 text-base font-semibold bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white shadow-2xl shadow-blue-600/40 hover:shadow-blue-600/60 transition-all duration-300 transform hover:scale-105 rounded-xl"
                >
                  Start Free Trial
        ...
        <div className="relative container mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <Button 
              size="lg" 
              onClick={() => setIsJoinModalOpen(true)}
              className="px-12 py-4 text-lg font-semibold bg-blue-600 hover:bg-blue-700 text-white shadow-xl shadow-blue-600/25 hover:shadow-blue-600/40 transition-all duration-300 transform hover:scale-105"
            >
              Start Free Trial
              <ArrowRight className="w-5 h-5 ml-2" />
            </Button>
