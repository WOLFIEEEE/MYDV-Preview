...
CREATE TABLE "sale_details" (
	...
	"delivery_type" varchar(20) DEFAULT 'collection',
...
CREATE TABLE "saved_invoices" (
	...
	"invoice_to" varchar(100),
	"total_amount" varchar(50) NOT NULL,
	"remaining_balance" varchar(50) DEFAULT '0',
	"is_paid" boolean DEFAULT false NOT NULL,
	"status" varchar(50) DEFAULT 'draft' NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
...
CREATE INDEX "idx_custom_invoices_payment_status" ON "custom_invoices" USING btree ("payment_status");--> statement-breakpoint
CREATE INDEX "custom_terms_dealer_id_idx" ON "custom_terms" USING btree ("dealer_id");--> statement-breakpoint
...
CREATE INDEX "idx_dealership_costs_due_date" ON "dealership_costs" USING btree ("due_date");--> statement-breakpoint
...
CREATE INDEX "idx_fund_transactions_status" ON "fund_transactions" USING btree ("status");--> statement-breakpoint
...
CREATE INDEX "idx_inventory_details_funding_source_id" ON "inventory_details" USING btree ("funding_source_id");--> statement-breakpoint
...
CREATE INDEX "idx_sale_details_customer_id" ON "sale_details" USING btree ("customer_id");--> statement-breakpoint
...
CREATE INDEX "idx_service_details_dealer_id" ON "service_details" USING btree ("dealer_id");--> statement-breakpoint
...
CREATE INDEX "idx_vehicle_documents_reg_dealer" ON "vehicle_documents" USING btree ("registration","dealer_id");--> statement-breakpoint
